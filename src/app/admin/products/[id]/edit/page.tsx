    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          uv400: product.uv400 ?? product.prescriptionCompatible ?? false,
          ...
          {images.length > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {images.map((img, index) => (
                <div key={index} className="relative aspect-square bg-gray-100 dark:bg-gray-600 rounded-lg overflow-hidden group">
                  <Image
                    src={img}
